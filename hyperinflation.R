...
png(file="hyperinflation.dur.png", width=400, height=400, bg="white")
...
png(file="hyperinflation.rate.png", width=400, height=400, bg="white")
par(mai=c(0.5,1,0.25,0.25))
...
png(file="hyperinflation.ts.png", width=800, height=300, bg="white")
par(mai=c(0.5,1,0.25,0.25))
...
png(file="hyperinflation.duration.png", width=500, height=500, bg="white")
